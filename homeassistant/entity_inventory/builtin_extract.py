#!/usr/bin/env python3
"""
Entity extraction using only built-in Python modules
"""
...
def extract_entities_builtin():
    """Extract entities using built-in urllib"""
    ...
    try:
        ...
        if e.code == 401:
            ...
            print("💡 Or try: curl -H 'Authorization: Bearer YOUR_TOKEN' http://192.168.86.2:8123/api/states")
            return False
        else:
...
def main():
    success = extract_entities_builtin()
